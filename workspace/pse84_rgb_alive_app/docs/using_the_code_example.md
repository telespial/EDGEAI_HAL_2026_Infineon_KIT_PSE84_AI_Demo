...
The following example clones the "[mtb-example-psoc-edge-ml-deepcraft-deploy-radar](https://github.com/Infineon/mtb-example-psoc-edge-ml-deepcraft-deploy-radar)" application with the desired name "DeployRadar" configured for the *KIT_PSE84_AI* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_AI --app-id mtb-example-psoc-edge-ml-deepcraft-deploy-radar --user-app-name DeployRadar --target-dir "C:/mtb_projects"
   ```
